 ...
 *
 */
$engine = 'Apc';	//I recomend APC for core and model, then we don't need to check on EVERY request
...
Cache::config('default', array(
	...
	'duration'=> 3600, //[optional]
	'probability'=> 100, //[optional]
	'prefix' => 'post_config_dev', //[optional]  prefix every cache file with this string
));
